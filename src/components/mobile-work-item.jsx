  ...
  return (
    ...
    >
      ...
      <div className="pt-[25px] px-[30px] pb-[30px] ">
        ...
        <p className="break-words mb-2  h-auto">{description}</p>

        <div className="flex flex-wrap cursor-default">
          {techStack.map((tech) => (
            <div className="font-roboto text-[14px] mr-2 my-1 p-2 border border-solid border-primary rounded-md">
              {tech}
            </div>
          ))}
        </div>
